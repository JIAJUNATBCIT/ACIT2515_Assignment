...
class AddSwordPopup(tk.Frame):
    ...
    def __init__(self, parent, close_callback):
        ...
        tk.Label(self, text="Sharp:").grid(row=7, column=1)
        self._sharp = tk.Entry(self)
        self._sharp.grid(row=7, column=2)
        tk.Label(self, text="Length:").grid(row=8, column=1)
        self._length = tk.Entry(self)
        self._length.grid(row=8, column=2)
        tk.Label(self, text="Double Edged:").grid(row=9, column=1)
